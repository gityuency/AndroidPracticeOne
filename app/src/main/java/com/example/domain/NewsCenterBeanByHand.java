...
public class NewsCenterBeanByHand {

    private List<DetailPagerData> data;    //如果不添加  setter 和 getter 函数, 那么就把 前面的 private 改成 public, 否则这些属性都是访问不到的.
    private List extend;
    private int retcode;
